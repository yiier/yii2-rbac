...
<div class="row">
    <div class="col-xs-12">
        <p><?= Yii::t('rbac', 'Click{name}, background color change after says it has chosen', ['name' => Yii::t('rbac', 'Permission')]) ?></p>
            ...
            <ul class="u-list">
                <?php foreach ($v as $key => $val): ?>
                    <li rel="user-id" data-id="<?= $val['name'] ?>"
                        class="assign-permissions<?php if ($val['is_sel']) echo ' selected'; ?>">
